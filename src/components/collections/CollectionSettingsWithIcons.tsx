...
interface CollectionSettingsWithIconsProps {
...
export function CollectionSettingsWithIcons({
  collection,
  onUpdate,
  onUpdateIcon,
  onUpdateColor,
  isLoading = false
}: CollectionSettingsWithIconsProps) {
  ...
  return (
    <div className="collection-settings bg-white rounded-lg shadow p-6">
      ...
      <div className="space-y-4 mb-6">
        <h4 className="font-medium text-gray-900 border-b pb-2">Personalização</h4>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <label className="text-sm text-gray-700 block mb-2">Ícone</label>
            <CollectionIcon
          ...
          <div>
            <label className="text-sm text-gray-700 block mb-2">Cor Principal</label>
